...
import (
	...
	"github.com/wagoodman/go-bouncer/bouncer/event"
...
func ParseModuleScanStarted(e partybus.Event) (progress.StagedProgressable, error) {
...
func ParseModuleScanResult(e partybus.Event) (presenter.Presenter, error) {
